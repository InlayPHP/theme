...
final class Theme implements JsonSerializable
{
    ...
    public static function base(): self
    {
        return self::make('base')->tokens([
            ...
            // Orbit-aligned canonical roles. Base shares the same light values
            // as the orbit preset so the two presets agree on every new token.
            ...
            'sidebar-active' => 'rgb(129 140 248 / 0.18)',
            'sidebar-active-foreground' => '#c4b5fd',
            'sidebar-badge' => '#3f3f46',
        ]);
    }
    ...
    public static function orbit(): self
    {
        return self::base()->named('orbit')->tokens([
            ...
            'sidebar-surface' => '#fcfdff',
            'sidebar-foreground' => '#1a1f29',
            'sidebar-muted' => '#535862',
            'sidebar-border' => '#d7dbe3',
            'sidebar-hover' => '#f1f3fd',
            ...
            // Canonical Orbit roles. Light values are the equivalent sRGB
            // fallbacks from colors_and_type.css; dark values are the canonical
            // dark oklch strings verbatim.
            'focus-ring' => 'rgb(142 148 229 / 0.45)',
            ...
            'sidebar-surface' => 'oklch(0.215 0.02 264)',
            'sidebar-foreground' => 'oklch(0.97 0.01 264)',
            'sidebar-muted' => 'oklch(0.72 0.018 264)',
            'sidebar-border' => 'oklch(0.34 0.024 264)',
            'sidebar-hover' => 'oklch(0.28 0.024 276)',
            'sidebar-active' => 'oklch(0.34 0.09 276)',
            'sidebar-active-foreground' => 'oklch(0.98 0.006 276)',
            'sidebar-badge' => 'oklch(0.31 0.025 264)',
            'shadow' => '0 1px 2px oklch(0.06 0.02 264 / 0.24), 0 1px 3px oklch(0.06 0.02 264 / 0.18)',
            // Canonical Orbit dark mirrors from the [data-theme="dark"] block.
            'focus-ring' => 'oklch(0.78 0.14 276 / 0.62)',
            'surface-subtle' => 'oklch(0.265 0.024 264)',
            'surface-strong' => 'oklch(0.31 0.027 264)',
            'fg-strong' => 'oklch(0.97 0.01 264)',
            'muted-strong' => 'oklch(0.78 0.018 264)',
            'border-strong' => 'oklch(0.48 0.032 264)',
            'accent-soft' => 'oklch(0.32 0.08 276)',
            'accent-strong' => 'oklch(0.72 0.14 276)',
            'accent-border' => 'oklch(0.62 0.12 276)',
            'success-strong' => 'oklch(0.76 0.12 154)',
            'success-soft' => 'oklch(0.3 0.07 154)',
            'warning-strong' => 'oklch(0.82 0.12 76)',
            'warning-soft' => 'oklch(0.34 0.08 76)',
            'danger-strong' => 'oklch(0.76 0.14 25)',
            'danger-soft' => 'oklch(0.34 0.09 25)',
            'info-strong' => 'oklch(0.84 0.11 230)',
            'sidebar-badge-bg' => 'oklch(0.31 0.025 264)',
            'sidebar-card-bg' => 'oklch(0.255 0.022 264)',
            'shadow-md' => '0 14px 36px oklch(0.06 0.02 264 / 0.32), 0 2px 6px oklch(0.06 0.02 264 / 0.22)',
        ]);
    }
